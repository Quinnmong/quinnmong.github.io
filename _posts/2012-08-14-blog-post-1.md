...
<img src="{{ '/assets/css/1.png' | relative_url }}"
     alt="Debate setup"
     style="width:20% !important; height:auto; max-width:none;">
...
<figure>
  <img src="{{ '/_posts/2.png' | relative_url }}" alt="Superalignment analogy and QuALITY setup" width="900">
  <figcaption><strong>Figure 2.</strong> Analogy: LLM experts read the passage; the human or weak judge cannot.</figcaption>
</figure>
