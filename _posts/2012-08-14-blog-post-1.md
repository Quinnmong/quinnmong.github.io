...
<figure>
  <img src="{{ '/assets/css/1.png' | relative_url }}" alt="Debate setup" width="700">
  <figcaption><strong>Figure 1.</strong> Debate setup — judge hears arguments from both LLMs.</figcaption>
</figure>
